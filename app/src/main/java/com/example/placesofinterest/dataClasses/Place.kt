package com.example.placesofinterest.dataClasses

import androidx.annotation.DrawableRes
import com.example.placesofinterest.R

// the two values in place are name and image.
// by making use of a companion object you can link the place names to the images!
data class Place(
    var name: String,
